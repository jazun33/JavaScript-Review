...
//30 and an array full or numbers 'randomArray'. Your job is to write a function
//that will get a random number, then loop through the array to see if that
//random number is in the array. If it is, alert true, if it's not, alert false
...
//Create a copy of first and save it into second. Then, add 6 and 7 to the end
//of second. When you run this, first should be just [1,2,3,4,5] and second will
//be [1,2,3,4,5,6,7] if you created your copy correctly.
var first = [1,2,3,4,5];
var second;
...
//write a function called capitalize that takes in the myPoem variable and
...
var theOdyssey = "function expression or function declaration? " +
  "Tis an obvious choice";
