...
var map = function(numArray, fn) {
  for (var i = 0; i < numArray.length; i++) {
    numArray[i] = fn(numArray[i]);
  }
};
...
uniq(names, function(uniqArr){
  console.log('The new names array with all the duplicate items removed is ',
  uniqArr);
});
